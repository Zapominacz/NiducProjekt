...
% Last Modified by GUIDE v2.5 13-May-2015 23:32:10
...
maxKasa = get(handles.edit18, 'String');
maxKasaNumber = str2double(maxKasa);
...
czasPrzystosowaniaKucharzy = str2double(get(handles.edit28, 'String')) * 30*24*60*60;
